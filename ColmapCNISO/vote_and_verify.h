...
// Shalev: OverlapResult for PAMI spatial verification.
class OverlapResult {
public:
	//vector<T> subSet;
	...
	int startIndex;
	int endIndex;
	int startIndexAccordingToMatlab;
	int endIndexAccordingToMatlab;
	int startOrigIndex;
	int endOrigIndex;
};
...
int VoteAndVerify(const VoteAndVerifyOptions& options, const int& num_images_after_verification,// Shalev - Added num_images_after_verification
