...
// Shalev: perform PAMI spatial verification.
#include <iostream> // Shalev: perform PAMI spatial verification.
using namespace std; // Shalev: perform PAMI spatial verification.
extern int PAMI_spatial_verification; // Shalev: perform PAMI spatial verification.
//extern int Ng_th; // Shalev: when applying different threshold for Ng
extern int maxOptionsPAMI; // Shalev: perform PAMI spatial verification.
...
void MainWindow::MatchMatrix() {
	match_matrix_widget_->Show(); /*shalev T.B.D*/ PAMI_spatial_verification++; if (PAMI_spatial_verification > maxOptionsPAMI) { PAMI_spatial_verification = 0; } cout << "PAMI_spatial_verification = " << PAMI_spatial_verification << endl;
}
